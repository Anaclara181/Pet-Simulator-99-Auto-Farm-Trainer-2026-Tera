...
import time
import offsets
from memory import SuperTrainer

class SuperTrainerApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Tera Pet Simulator 99 Auto Farm Trainer 2026")
...
if __name__ == "__main__":
    ...
    style.configure("TButton", background="#DA70D6", foreground="white")
    style.configure("TLabel", background="#0f0f0f", foreground="white")
    style.configure("TCheckbutton", background="#0f0f0f", foreground="white")
    app = SuperTrainerApp(root)
    root.mainloop()
